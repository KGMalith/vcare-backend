...
INSERT INTO `permissions` (`permission_name`, `permission_category`, `permission_desc`) VALUES ('View User Details', 'Users', 'View own profile details');
INSERT INTO `permissions` (`permission_name`, `permission_category`, `permission_desc`) VALUES ('Update Profile', 'Users', 'Update own profile details');
...
INSERT INTO `permissions` (`permission_name`, `permission_category`, `permission_desc`) VALUES ('View Profile Details', 'Patient', 'View own profile details');
INSERT INTO `permissions` (`permission_name`, `permission_category`, `permission_desc`) VALUES ('Update Profile Details', 'Patient', 'Update own profile details');
...
INSERT INTO `permissions` (`permission_name`, `permission_category`, `permission_desc`) VALUES ('View Profile Details', 'Doctor', 'View own profile details');
INSERT INTO `permissions` (`permission_name`, `permission_category`, `permission_desc`) VALUES ('Update Profile Details', 'Doctor', 'Update own profile details');
...
INSERT INTO `permissions` (`permission_name`, `permission_category`, `permission_desc`) VALUES ('Add Appointment', 'Appointments', 'Create appointment on behalf of patient');
INSERT INTO `permissions` (`permission_name`, `permission_category`, `permission_desc`) VALUES ('Delete Appointment', 'Appointments', 'Cancel appointment on behalf of patient');
INSERT INTO `permissions` (`permission_name`, `permission_category`, `permission_desc`) VALUES ('Create Appointment', 'Appointments', 'Create appointment by patient');
INSERT INTO `permissions` (`permission_name`, `permission_category`, `permission_desc`) VALUES ('Cancel Appointment', 'Appointments', 'Delete appointment by patient');
INSERT INTO `permissions` (`permission_name`, `permission_category`, `permission_desc`) VALUES ('View All Own Appointments', 'Appointments', 'View all own appointments');
...
INSERT INTO `permissions` (`permission_name`, `permission_category`, `permission_desc`) VALUES ('View All Own Admissions', 'Admissions', 'View all own admissions');
